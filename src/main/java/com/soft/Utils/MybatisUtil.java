...
public class MybatisUtil {
    ...
    public static SqlSession buildSqlSessionFactory() {
        ...
        //扫描mapper接口所在包
        configuration.addMappers("com.soft.dao");
    ...
    private static DataSource initDataSource() {
        ...
        dataSource.setJdbcUrl("jdbc:mysql://47.103.40.79:3306/software_design_pattern?useUnicode=true&characterEncoding=UTF-8&useSSL=false&autoReconnect=true&failOverReadOnly=false");
        dataSource.setDriverClassName("com.mysql.cj.jdbc.Driver");
        dataSource.setUsername("root");
        dataSource.setPassword("YYcx2928999.");
