...
public class MyGenerator {
    public static void main(String[] args) {
        ...
        gc.setOutputDir("D:\\message\\JavaProject\\software_design_patterns\\src\\main\\java"); // 代码输出目录
        gc.setAuthor("th_js_wcx"); // 作者
        gc.setOpen(false); // 生成后是否打开文件夹
//        gc.setSwagger2(true); // 是否使用Swagger2注解
        gc.setDateType(DateType.ONLY_DATE); // 时间类型
        gc.setFileOverride(true);//开启覆盖
        ...
        dataSourceConfig.setUrl("jdbc:mysql://47.103.40.79:3306/software_design_pattern?useUnicode=true&characterEncoding=UTF-8&useSSL=false&autoReconnect=true&failOverReadOnly=false");
